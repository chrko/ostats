ALTER IGNORE TABLE `alliance` DROP `last_update`;

ALTER IGNORE TABLE `alliance_log_homepage` DROP `seen`;
ALTER IGNORE TABLE `alliance_log_logo` DROP `seen`;
ALTER IGNORE TABLE `alliance_log_name` DROP `seen`;
ALTER IGNORE TABLE `alliance_log_tag` DROP `seen`;

ALTER IGNORE TABLE `alliance_overall` DROP `first_seen`;
ALTER IGNORE TABLE `alliance_overall` DROP `last_seen`;

ALTER IGNORE TABLE `alliance_member` DROP `first_seen`;
ALTER IGNORE TABLE `alliance_member` DROP `last_update`;

ALTER IGNORE TABLE `alliance_member_log` DROP `first_seen`;
ALTER IGNORE TABLE `alliance_member_log` DROP `last_seen`;


ALTER IGNORE TABLE `moon` DROP `first_seen`;
ALTER IGNORE TABLE `moon` DROP `last_update`;

ALTER IGNORE TABLE `moon_overall` DROP `first_seen`;
ALTER IGNORE TABLE `moon_overall` DROP `last_seen`;


ALTER IGNORE TABLE `planet` DROP `first_seen`;
ALTER IGNORE TABLE `planet` DROP `last_update`;

ALTER IGNORE TABLE `planet_overall` DROP `first_seen`;
ALTER IGNORE TABLE `planet_overall` DROP `last_seen`;

ALTER IGNORE TABLE `planet_relocation` DROP `seen`;


ALTER IGNORE TABLE `player` DROP `last_update`;

ALTER IGNORE TABLE `player_overall` DROP `first_seen`;
ALTER IGNORE TABLE `player_overall` DROP `last_seen`;

ALTER IGNORE TABLE `player_log_name` DROP `seen`;
ALTER IGNORE TABLE `player_log_vacation` DROP `seen`;


ALTER TABLE `highscore_1_0` REMOVE PARTITIONING;
ALTER IGNORE TABLE `highscore_1_0` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_1_1` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_1_2` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_1_3` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_1_4` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_1_5` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_1_6` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_1_7` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_2_0` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_2_1` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_2_2` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_2_3` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_2_4` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_2_5` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_2_6` DROP `seen`;
...
ALTER IGNORE TABLE `highscore_2_7` DROP `seen`;
...
ALTER IGNORE TABLE `tasks` DROP `due_time`;
